...
fun main() {
    ...
    val aa = pgm1_without_parameters()

    // Since Class A has no properties or methods, nothing specific to print or demonstrate here
    println("Instance of A created successfully.")
}
